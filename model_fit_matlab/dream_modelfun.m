...
function ymodel=dream_modelfun(theta,xdata,sim,Delta,Max_iter,a_a_estimate)
    ...
    for i=1:size(xdata,1)
        ...
        sim.parameters('h_ext')=xdata(i,2); % modified - now external Cm conc. is a parameter
        ...
        ymodel(i,2)=R.*sim.parameters('n_r')./sim.parameters('M'); % record ribosome mass fraction
    end
end